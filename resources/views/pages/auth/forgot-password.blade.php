    ...
    <div class="card-body px-md-5 py-5">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input placeholder="your email here" type="text" class="form-control p_input text-white" name="email" id="email">
                @error('email') <small class="fst-italic text-white">{{ $message }}</small> @enderror
            </div>
