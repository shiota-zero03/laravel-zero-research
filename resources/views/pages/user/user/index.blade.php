...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">User Data</div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card p-md-3 p-2">
                <div class="d-md-flex align-items-center justify-content-between d-none">
                    <div class="my-1">
...
@section('script')
    ...
    <script>
        var db_table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.user.index', 'user-data') }}",
            columns: [
        ...
        function openModal(id){
            ...
            if(id === 0){
                $.ajax({
                    url: "{{ route('admin.user.create', 'user-data') }}",
                    method: "GET",
                ...
                $.ajax({
                    url: "/administrator/user/user-data/"+id+"/edit",
                    method: "GET",
                    success: function(res){
                        action.val(res.data.action);
                        method.val(res.data.method);
        ...
        function deleteData(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/user/user-data/"+id,
                        method: "DELETE",
                        headers: {
